        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 animate-fade-in-up">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-6 sm:mb-8 leading-relaxed">
              ik ben een HBO-ICT student met een passie voor full-stack development. Ik bouw complete webapplicaties
              waarin de front-end en back-end naadloos samenwerken. Mijn kracht ligt in het ontwikkelen van schaalbare
              systemen, overzichtelijke interfaces en het vertalen van gebruikersbehoeften naar technische oplossingen.
            </p>
        ...
        <Card className="max-w-2xl mx-auto">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Ik ben momenteel op zoek naar een stageplek waar ik kan bijdragen en tegelijkertijd veel kan leren. Neem
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              ...
              <Button variant="outline" asChild>
                <a href="https://github.com/Jasper20037" target="_blank" rel="noopener noreferrer">
